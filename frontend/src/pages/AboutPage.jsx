        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Tendbee är engagerade i FN:s Agenda 2030 och arbetar aktivt för att bidra 
              till de globala målen för hållbar utveckling.
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {[
              { number: 4, title: 'God utbildning', icon: GraduationCap, color: '#C5192D', description: 'Keeada Academy ger alla chansen till utbildning' },
              { number: 5, title: 'Jämställdhet', icon: Scale, color: '#FF3A21', description: 'Anonyma matchningar utan diskriminering' },
              { number: 8, title: 'Anständigt arbete', icon: Briefcase, color: '#A21942', description: 'Vi kopplar samman jobbsökare med arbetsgivare' },
              { number: 10, title: 'Minskad ojämlikhet', icon: Heart, color: '#DD1367', description: 'Lika möjligheter oavsett bakgrund' },
            ].map((goal) => (
              <div key={goal.number} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center">
                <Handshake className="w-8 h-8 text-white" />
              </div>
              <div>
                <p className="text-sm text-gray-500 mb-1">Stolt medlem av</p>
                <p className="font-bold text-gray-900 text-lg">Diversity Charter Sweden</p>
              </div>
            </div>
            <Button 
